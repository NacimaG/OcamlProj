...
and str_acm={
 ...
 (*
test si structure deja vu
    --> struing -> strs_acm -> acm ref * bool    
 *)   
...
ajout d'une nouvelle structure
    --> string -> strs_acm -> acm ref -> strs_acm 
 *)  
...
(*
combiner abr et abre compressé map
    --> int abr -> acm ref -> NodeMAp.key -> acm ref 
 *)  
...
(*
reherche de valeur dans un node
    --> int -> acm -> int * NodeMap.key
*)
