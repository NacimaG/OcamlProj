...
(* Structures utilisé dans le Arbres compressé utilisant des ABR comrpessé 
*)
...
(*
    --> string -> strs_acmCInner ref -> strs_acmCInner
*)
...
(*
    --> 'a -> ('a * acmCOuter ref) list -> acmCOUter ref * boul
*)    
...
(*
    --> acm ref -> (acm ref * acmCOuter ref) list ref -> acmCOuter ref
*)
...
(*
    --> int -> int list -> acmCInner -> (int * NodeMap.key) * int
*)
